...
function parse(rawArgv) {
  ...
  function showHelp(specifiedScripts) {
    ...
    var commandIsHelp = (0, _lodash.isEqual)(specifiedScripts, ['help']) && !hasHelpScript;
  ...
  function getPSConfigFilepath() {
    ...
    return _findUp2.default.sync('package-scripts.js') || _findUp2.default.sync('package-scripts.yml');
  }
}
